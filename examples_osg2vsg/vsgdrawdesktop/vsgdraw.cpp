...
class vsgDrawExample : public vsgExamples::ExampleBase
{
public:
	vsgDrawExample() {}
...
{
	vsg::ref_ptr<vsgDrawExample> drawexample(new vsgDrawExample());
	int initresult = drawexample->Init(argc, argv);
	if (initresult != 0) return initresult;

	while (drawexample->Update() == 0)
	{
	}
